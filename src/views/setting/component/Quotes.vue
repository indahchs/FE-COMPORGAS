  ...
  <div>
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="10"
        ><span class="title-page">Quote Master</span></v-col
      >
      <v-col cols="12" sm="6" md="4" lg="2">
        <v-btn class="btn-submit" @click="add"> Create Quote </v-btn>
      </v-col>
    </v-row>
    <v-card class="mt-4">
      <v-card-text>
...
import CreateQuote from "./CreateQuotesFormModal.vue";
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "Text Quote", value: "name", width: 400 },
        { text: "Start Date", value: "startDate" },
        { text: "End Date", value: "endDate" },
        { text: "Person", value: "namePeople" },
        { text: "Title", value: "titlePeople" },
        { text: "Attachment", value: "imageUrl" },
