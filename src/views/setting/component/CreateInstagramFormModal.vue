    ...
    <v-dialog v-model="isOpen" width="400" persistent>
      <v-card>
        ...
        <v-card-text>
          <v-row>
            <v-col cols="12">
              <label class="required">Caption</label>
              <quill-editor
                class="editor mb-5"
                ref="myTextEditor"
                :style="
            ...
            <v-col cols="12" style="margin-top: -25px">
              ...
              <v-row style="margin: 0px" class="mb-5 mt-4">
                ...
                >
                  ...
                  ><br />
                  <span class="font-subt">Choose Image or Video</span><br />
                ...
                >
                  ...
                  <div v-if="!isUpload">
                    <img
                      ...
                      :src="isManual ? imgUpload : selectedFile1"
                    />
                    <video
                      v-else
                      ref="videoPlayer"
                  ...
                  <div v-else>
                    ...
                    <video
                      ...
                      loop
                    >
                      <source :src="imgUpload" type="video/mp4" />
                    </video>
                  </div>
...
import InstagramService from "../../../services/management/instagram/instagramServices";

const service = InstagramService.build();
...
export default {
  ...
  methods: {
    ...
    getErrors(name, model) {
      ...
      switch (name) {
        case "name":
          ...
          !model.required && errors.push("Caption is required.");
          break;
        case "startDate":
    ...
    edit() {
      if (this.item != null) {
        this.title = "Edit Instagram";
        this.id = this.item.id;
        this.name = this.item.caption;
        ...
        this.imgUpload = this.baseUrl + this.item.mediaUrl;
        this.selectedFile1 = this.item.mediaUrl;
        this.isManual = this.item.manual;
        this.mediaType = this.item.mediaType;
        this.isYear = false;
        this.isYear1 = false;
        this.isName = false;
        this.isPict = false;
