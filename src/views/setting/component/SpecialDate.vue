  ...
  <div>
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="10"
        ><span class="title-page">Special Date</span></v-col
      >
...
import SpecialDateService from "../../../services/management/special_date/specialDateServices";

const service = SpecialDateService.build();
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "Title", value: "name", width: 600 },
